...
plt.subplot(1, 2, 1)
plt.errorbar(
    agg["worker_queue_len"], agg["drop_mean"], marker="o", capsize=3, color="#f4a261"
)
...
plt.subplot(1, 2, 2)
plt.errorbar(
    agg["worker_queue_len"], agg["p95_mean"], marker="o", capsize=3, color="#f4a261"
)
plt.xlabel("Max queue length per worker")

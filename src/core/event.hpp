...
struct Event {
    ...
    static Event invocation_start(TimePoint t,
                                  InvocationId inv_id,
                                  FunctionId func_id)
    {
        Event e;
    ...
    static Event invocation_execute(TimePoint t,
                                    InvocationId inv_id,
                                    FunctionId func_id,
                                    WorkerId   wid)
    {
    ...
    static Event invocation_complete(TimePoint t,
                                     InvocationId inv_id,
                                     FunctionId func_id,
                                     WorkerId   wid)
    {
    ...
    static Event container_cool(TimePoint t,
                            FunctionId func_id,
                            WorkerId wid)
    {
        Event e;
